        ...
        <Row>
          <Col className="home-card">
            <div className="about-text">
              <strong>
                <p>
                  Born and raised in Venezuela but currently living in the
                  United States since 2016. Learning a new culture, new people
                  and a completely new language has made me grow as a person. I
                  have always been passionate about computers and new
                  technologies. A few months ago I decided to do the big jump
                  and study full stack web development.
                </p>
                <p>
